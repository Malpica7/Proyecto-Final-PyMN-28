...
for(j=0;j<5;j++)
{
    if(j==0){ 
        ...
        xiteracion2 = ((-A[1][0]*xiteracion1)+b[1])/A[1][1];
        
        xiteracion3 = ((-A[2][0]*xiteracion1)-(A[2][1]*xiteracion2)+b[2])/A[2][2];
        
        printf("Metodo Gaus Seidel\n" );
        ...
        xiteracion2 = ((-A[1][0]*xiteracion1)-(A[1][2]*xiteracion3)+b[1])/A[1][1];
        ...
        printf("x2 La iteracion %d es %f con un error de %f %%\n",j+1,xiteracion2,Ea2);
