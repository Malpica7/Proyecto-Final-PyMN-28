...
void menu(void)
{
	...
	do{
		system ("cls");
		printf ("\n Menu");
		printf("\n1.-Diferencia hacia adelante con dos terminos O(h^2). ");
		printf("\n2.-Diferencia hacia atras con dos terminos O(h^2). ");
		printf("\n3.-Diferencia centrada con los cuatro terminos definidos O(h^4). ");
		printf("\n0.-SALIR ");
		printf("\n Elije una opcion ");
		scanf("%d",& op);
		switch (op)
